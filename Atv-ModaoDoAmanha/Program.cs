...
Console.WriteLine($"Desconto de horas: {aluno.DescontoHoras()}");
Console.WriteLine($"Seu nível: {aluno.NivelHabilidade}");
Console.WriteLine($"Para você ir para o próximo nível: {aluno.HorasFaltantesProximoNivel()}");
Console.WriteLine($"Sua mensalidade final: {aluno.MensalidadeFinal()}");
